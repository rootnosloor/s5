...
#----------------------------------------------------------
helpMessage ="""(╣•ALISH JOKER BOT̰̰̈́••╣)
✰ Hay (sapa si bot)
✰ Playstore NamaApp
✰ Fancytext: Text
...
Bots=[mid]
Creator= "u8b97ff6d6190da6f27485d9513a353e9" #bukan mid bot nya ya tapi mid si pembuat bot
admin= "u8b97ff6d6190da6f27485d9513a353e9" #yang ini samakan aja kayak mid creator
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By ALISH JOKER",    
    "commentOn":True,
    "commentBlack":{},
    "blacklist":{},
    "wblacklist":False,
...
#-----------------------------------------------
  ...
  #                  if wait["tagall"] == False:  
                         ...
                         msg.contentType = 13
                         msg.contentMetadata = {'mid': 'u8b97ff6d6190da6f27485d9513a353e9'}
                         msg.contentMetadata = {'mid': 'u5740a932f880a2913b4c645dc5ebe6d5'}
                         cl.sendMessage(msg)
...
#--------------------------------------------------------
                ...
                midd = "u8b97ff6d6190da6f27485d9513a353e9"
                cl.findAndAddContactsByMid(midd)
                cl.inviteIntoGroup(msg.to,[midd])
#--------------------------------------------------------
...
#--------------------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        cl.sendText(msg.to,"Bye beb..i will miss you..:(\n Add ya kaka  Jangan Lupa add OA kita http://line.me/ti/p/~joker.alish")
                        time.sleep(1.0)
                        msg.contentType = 13
                        msg.contentMetadata = {'mid': msg.from_}
                        cl.sendMessage(msg)
